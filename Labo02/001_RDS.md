...
Note: AWS RDS doesn't support MariaDB 11.2.3. We can use MariaDB 10.11 instead, as it should be compliant with Drupal.

Source: [Database server requirements](https://www.drupal.org/docs/getting-started/system-requirements/database-server-requirements
)
...
![RDS Cost](./img/RDS_COST_NGL.png)
Source: provided by NGL through Teams.

![RDS Estimate](./img/RDS_ESTIMATE.png)
Source: generate on (AWS calculator)[https://calculator.aws/]
